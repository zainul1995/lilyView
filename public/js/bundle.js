...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"youtube.js":[function(require,module,exports) {
// /* eslint-disable */
...
//         player.stopVideo();
//       }
},{}],"userEntry.js":[function(require,module,exports) {
"use strict";
...
var _userEntry = require("./userEntry");
...
var x = 0;
var player;
console.log('hellow from index'); //DOM elements

var signUpForm = document.querySelector('.form--signup');
var loginForm = document.querySelector('.form--login');
var uploadVideo = document.querySelector('.form--upload');
var btnLoad = document.getElementById('load-videos');
var btnNext = document.getElementById('next-video');
var badgeCounter = document.getElementById('counter');
var question = document.querySelector('.question-class');
var btnClaim = document.getElementById('claim');

var changeVideo = function changeVideo() {
  var videoId;
  videoId = video[x].submittedVideoIds; // question.innerHTML= '';
  // let y = 1; 
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _userEntry.signup)(name, email, password, passwordConfirm);
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _userEntry.login)(email, password);
  });
}
...
if (btnLoad) {
  //   3. This function creates an <iframe> (and YouTube player)
  //      after the API code downloads.
  var _onYouTubeIframeAPIReady = function _onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      height: '240',
      width: '340',
      videoId: 'M7lc1UVf-VE',
  ...
  var _onPlayerStateChange = function _onPlayerStateChange(event) {
    if (event.data == YT.PlayerState.PLAYING && !done) {
      setTimeout(_stopVideo, 600000);
      done = true;
      setInterval(calcCounts, 1000);
    }
  };

  var _stopVideo = function _stopVideo() {
    player.stopVideo();
  };
  ...
  var loadIds = /*#__PURE__*/function () {
    ...
    return function loadIds() {
      return _ref2.apply(this, arguments);
    };
  }();

  btnLoad.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
...
if (btnClaim) {
  btnClaim.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var cored;
...
var updatePoints = /*#__PURE__*/function () {
...
var calcCounts = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            console.log(counter);
            badgeCounter.textContent = "".concat(counter, "/").concat(video[x].time);
  ...
  return function calcCounts() {
    return _ref6.apply(this, arguments);
  };
}();

if (uploadVideo) {
  uploadVideo.addEventListener('submit', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var submittedVideoIds, time, noOfViews, res;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            submittedVideoIds = document.getElementById('url').value;
            time = document.getElementById('watchtime').value;
            noOfViews = document.getElementById('number').value;
            _context7.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","axios":"../../node_modules/axios/index.js","./youtube":"youtube.js","./userEntry":"userEntry.js"}]},{},["index.js"], null)
